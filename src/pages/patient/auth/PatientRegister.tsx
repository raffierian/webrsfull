...
import { Heart, Loader2, ArrowLeft, ShieldCheck, Clock, Activity, ArrowRight, UserPlus } from 'lucide-react';
...
const PatientRegister = () => {
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2 bg-gradient-to-br from-indigo-50/50 via-white to-blue-50/50">
            {/* Left: Hero/Banner - Premium Medical Design (Identical to Login) */}
                ...
                <div className="relative z-10">
                    ...
                    >
                        <h1 className="text-5xl font-bold mb-6 leading-tight">
                            Bergabung dengan <br /> <span className="text-teal-200">Portal Pasien</span>
                        </h1>
                        <p className="text-lg text-teal-50/90 leading-relaxed max-w-md mb-10">
                            Nikmati kemudahan akses layanan kesehatan. Pendaftaran cepat, mudah, dan gratis untuk Anda dan keluarga.
                        </p>

                        <div className="flex gap-4">
                            {[
                                { icon: UserPlus, label: "Daftar Cepat", desc: "Hanya butuh 2 menit" },
                                { icon: ShieldCheck, label: "Data Aman", desc: "Privasi Terjamin" },
                                { icon: Activity, label: "Terintegrasi", desc: "Satu Akun Semua Layanan" }
                            ].map((item, idx) => (
            ...
            {/* Right: Register Form - Glassmorphism & Clean */}
            <div className="flex flex-col items-center justify-center p-6 lg:p-12 relative">
                <div className="w-full max-w-[500px] relative z-10">
                    <Link to="/patient/login" className="inline-flex items-center text-sm font-medium text-slate-500 hover:text-[#0F766E] transition-colors mb-8 group">
                    ...
                    <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60">
                        <div className="mb-8">
                            ...
                            <p className="text-slate-500 mt-2 text-sm leading-relaxed">
                                Isi formulir di bawah ini untuk membuat akun pasien baru.
                            </p>
                        </div>

                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="space-y-1.5">
                                <Label htmlFor="name" className="text-xs font-semibold uppercase tracking-wider text-slate-500 ml-1">Nama Lengkap</Label>
                                <Input
                                    id="name"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    <Label htmlFor="phone" className="text-xs font-semibold uppercase tracking-wider text-slate-500 ml-1">No. Telepon / WA</Label>
                                    <Input
                                        id="phone"
                                        type="tel"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    <Label htmlFor="confirmPassword" className="text-xs font-semibold uppercase tracking-wider text-slate-500 ml-1">Konfirmasi Password</Label>
                                    <Input
                                        id="confirmPassword"
                                        type="password"
                            ...
                            <Button
                                type="submit"
                                className="w-full h-12 bg-[#0F766E] hover:bg-[#0d655e] text-white rounded-xl font-semibold shadow-lg shadow-teal-700/20 hover:shadow-teal-700/30 transition-all transform hover:-translate-y-0.5 active:translate-y-0 mt-2"
                        ...
                        <div className="mt-8 pt-8 border-t border-slate-100 text-center">
                            <p className="text-sm text-slate-500 mb-4">Sudah memiliki akun?</p>
                        ...
                        <p className="text-center text-xs text-slate-400 mt-6">
                            Dengan mendaftar, Anda menyetujui <a href="#" className="text-[#0F766E] hover:underline">Syarat & Ketentuan</a> kami.
                        </p>
                    </div>
                </div>
